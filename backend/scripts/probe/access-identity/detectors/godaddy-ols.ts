// backend/scripts/probe/access-identity/detectors/godaddy-ols.ts
...
//     downstream (navigation stage) rather than here.
//
...
// the catalog-crawler runtime, NOT for platform identification: the homepage
